...
class ReservationFileRepositoryTest {
    ...
    static final String TEST_FILE_PATH = "./data/reservations-data-test/2e72f86c-b8fe-4265-b4f1-304dea8762db.csv";
    ...
    void shouldAddReservation() throws DataException {
        ...
        assertEquals((LocalDate.of(2022,10,31)), reservation.getStartDate());
        assertEquals((LocalDate.of(2022,11,5)), reservation.getEndDate());
    }
    ...
    void shouldUpdateReservation() throws DataException {
        ...
        reservation.setEndDate(LocalDate.of(2022,12,18));
        reservation.setHost(host);
